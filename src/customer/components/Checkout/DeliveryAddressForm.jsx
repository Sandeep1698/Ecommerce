    ...
    <div>
        <Grid container spacing={4}>
            <Grid xs={12} lg={5} className='border rounded-e-md shadow-md h-[30.5rem] overflow-y-scroll'>
                <div className='p-5 py-7 border cursor-pointer'>
                    <AdressCard/>
                    <Button className='justify-content-start' sx={{mt:2,bgcolor:"RGB(145 85 253)"}} size='large' variant='contained'>Deliver Here</Button>
                </div>
            </Grid>
                ...
                <Box className='border rounded-s-md shadow-md p-5'>
                    <form onSubmit={handleSubmit}>
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField required id='mobile' name='mobile' label='Mobile No.' fullWidth autoComplete='given-name'/>
                            </Grid>
