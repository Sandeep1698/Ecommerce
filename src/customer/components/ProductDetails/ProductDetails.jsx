    ...
    return (
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-19 px-4 pt-10'>
                    {/* Image gallery */}
                    ...
                    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg:text-xl font-semibold text-grat-900" style={{paddingRight: "50rem"}}> {products.product?.brand}</h1>
                            <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1" style={{paddingRight: "17.3rem"}}>{products.product?.title}</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <p className='opacity-50 text-sm'>56678 Ratings</p>
                            <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3789 Reviews</p>
                            </div>
                            </div>
                            ...
                            <form className="mt-10">
                                ...
                                <div className='pt-5' style={{paddingRight:"20rem"}}>
                                <Button onClick={handleAddToCart} variant='contained' sx={{px:"1rem",py:"1rem",bgcolor:"#9155fd"}}>
                                    Add to cart
                                </Button>
                                </div>
                            </form>
                     ...
                     <Grid container spacing={7}>
                        ...
                        <Grid item xs={5}>
                         ...
                         <div className='flex items-center space-x-3'>
                            ...
                            <p className='opacity-60'>54670 Ratings</p>
                         </div>
                         <Box className='mt-5 space-y-3'>
                            ...
                            <Grid item xs={7}>
                                <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant='determinate' value={60} color='secondary'/>
                            </Grid>
                            </Grid>
                            <Grid container alignItems="center" gap={2}>
                            <Grid item xs={2}>
