        ...
        <div>
            <Grid className='bg-black text-white text-center mt-10' container sx={{ bgcolor: 'black', color: 'white', py: 3 }}>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    ...
                    <div><Button className='pb-5' variant='h6' gutterBottom>API</Button></div>
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                    ...
                    <div><Button className='pb-5' variant='h6' gutterBottom>TC</Button></div>
                </Grid>
                <Grid className='pt-20' item xs={12}>
                    <Typography variant="body2" component="p" align='center'>&copy; 2024 My company. All rights reserved.</Typography> 
                    <Typography variant="body2" component="p" align='center'>Made In India</Typography> 
                </Grid>
            </Grid>
        </div>
    )
